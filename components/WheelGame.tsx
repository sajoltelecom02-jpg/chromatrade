      ...
      <div className="relative aspect-square md:aspect-video bg-black rounded-3xl border-[6px] border-slate-800 shadow-2xl flex flex-col items-center justify-center group overflow-visible">
          ...
          >
              ...
              {Array.from({length: 54}).map((_, i) => (
                  <div 
                    key={i}
                    className="absolute z-20 w-[6px] h-[6px] rounded-full bg-gradient-to-br from-slate-100 to-slate-400 shadow-[1px_1px_2px_rgba(0,0,0,0.5)]"
                    style={{
                        top: '50%',
                        left: '50%',
                        ...
                        boxShadow: 'inset 1px 1px 1px rgba(255,255,255,0.9), 1px 1px 2px rgba(0,0,0,0.5)'
                    }}
                  ></div>
              ))}
